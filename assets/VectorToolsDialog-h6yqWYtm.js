import{o as Y}from"./rolldown-runtime-CEgmsyvS.js";import{t as re}from"./react-DIKiA8qT.js";import{C as oe,J as ie,Y as ae,d as se,f as le,h as K,l as de,p as ce,u as ue,w as pe}from"./context-CMjuLTtc.js";import{o as fe}from"./i18nInstance-DbcsXgO_.js";import{t as ge}from"./loader-circle-DiBxgrSG.js";import{t as me}from"./play-DZgtZ58X.js";import{t as he}from"./server-CpnrjEfW.js";import{t as ye}from"./useTranslation-BVqmcfbR.js";import{J as S}from"./src-B674GYJF.js";import{Jn as _e,Nn as ve,On as D,Pt as be,ft as we,jn as Z}from"./src-DDC8uGRW.js";import{Y as je}from"./src-6yxapqqI.js";import{t as xe}from"./processing-history-DmA-1pdM.js";import{a as ke,c as Se,o as Ee,s as Te}from"./processing-tool-i18n-CYssjZEZ.js";import{t as Ae}from"./pyodide-config-VUe9AbeO.js";import{t as Ne}from"./duckdb-processing-Cn0Z6K67.js";import{t as Oe}from"./ParameterField-BAhX-27G.js";var Pe=`# AUTO-GENERATED \u2014 do not edit. Source of truth:
...
`,Ie=12e4,Ce=3e5,E=null,Ge=0,w=new Map,M=new Set;function Re(c){return M.add(c),()=>M.delete(c)}function Ve(c){for(const r of M)r(c)}function De(){return"/pyodide/pyodide-worker.js"}function Me(){const c=Ae(),r=new Worker(De()),m=new Promise((j,f)=>{let v,u=!1;const x=g=>{if(!u){u=!0,v&&clearTimeout(v),r.terminate(),E=null;for(const[d,_]of w)w.delete(d),_.reject(new Error(g))}};v=setTimeout(()=>{const g="Timed out loading the Python runtime. Check your connection and try again.";x(g),f(new Error(g))},Ie),r.onmessage=g=>{const d=g.data??{};switch(d.type){case"progress":Ve(d.phase);break;case"ready":v&&clearTimeout(v),j();break;case"result":{const _=w.get(d.id);_&&(w.delete(d.id),_.resolve({geojson:d.geojson,messages:d.messages}));break}case"error":{const _=d.message||"Pyodide error";if(d.id===void 0)x(_),f(new Error(_));else{const a=w.get(d.id);a&&(w.delete(d.id),a.reject(new Error(_)))}break}}},r.onerror=g=>{const d=g.message||"Pyodide worker failed";x(d),f(new Error(d))}});return r.postMessage({type:"init",indexURL:c,vectorOpsSource:Pe}),m.then(()=>({worker:r}))}function Fe(){return E??=Me().catch(c=>{throw E=null,c}),E}async function Le(c){const{worker:r}=await Fe(),m=Ge++;return new Promise((j,f)=>{const v=setTimeout(()=>{if(w.has(m)){w.delete(m),r.terminate(),E=null;for(const[u,x]of w)w.delete(u),x.reject(new Error("Pyodide worker was reset after a timeout."));f(new Error("The Python (Pyodide) operation timed out."))}},Ce);w.set(m,{resolve:u=>{clearTimeout(v),j(u)},reject:u=>{clearTimeout(v),f(u)}}),r.postMessage({type:"run",id:m,request:c})})}var i=Y(re(),1),o=Y(fe(),1);function qe(){const c=[];for(const r of D){const m=r.group??"Tools";let j=c.find(f=>f.group===m);j||(j={group:m,tools:[]},c.push(j)),j.tools.push(r)}return c}function Ue({mapControllerRef:c}){const{t:r}=ye(),m=S(e=>e.ui.vectorToolOpen),j=S(e=>e.setVectorToolOpen),f=S(e=>e.layers),v=S(e=>e.addGeoJsonLayer),u=S(e=>e.ui.processingRerun),x=S(e=>e.setProcessingRerun),g=m!==null,[d,_]=(0,i.useState)(m??D[0].id),[a,T]=(0,i.useState)({}),[k,A]=(0,i.useState)("client"),[P,N]=(0,i.useState)([]),[F,L]=(0,i.useState)(!1),[I,q]=(0,i.useState)(null),[U,J]=(0,i.useState)(!1),W=(0,i.useRef)(null),B=(0,i.useRef)(null),l=(0,i.useMemo)(()=>Z(d)??D[0],[d]),H=(0,i.useMemo)(()=>Ne(),[]);(0,i.useEffect)(()=>{m&&_(m)},[m]),(0,i.useEffect)(()=>{const e={};for(const n of l.parameters)n.default!==void 0&&(e[n.id]=n.default);T(e),N([]),l.requiresSidecar?A("sidecar"):l.supportsSidecar||A("client")},[l]),(0,i.useEffect)(()=>{if(!g||!u||u.kind!=="vector")return;const e=ve(u.toolId,u.parameters);if(!Z(e.toolId)){N(n=>[...n,`Error: ${r("processing.history.toolUnavailable",{toolId:u.toolId})}`]),x(null);return}if(e.toolId!==l.id){d!==e.toolId&&_(e.toolId);return}T({...e.parameters}),(u.engine==="client"||u.engine==="sidecar"||u.engine==="pyodide")&&A((u.engine,u.engine)),x(null),u.autoRun&&J(!0)},[g,u,l,d,x,r]),(0,i.useEffect)(()=>{if(d!=="dggs-grid"||a.source!=="bbox"||a.west!==void 0||a.south!==void 0||a.east!==void 0||a.north!==void 0)return;const e=c.current?.getMap();if(!e)return;const n=e.getBounds(),t=s=>Number(s.toFixed(6));T(s=>({...s,west:t(n.getWest()),south:t(n.getSouth()),east:t(n.getEast()),north:t(n.getNorth())}))},[d,a.source,c]),(0,i.useEffect)(()=>{if(!g)return;let e=!1;return we().then(n=>{e||q(n.available)}).catch(()=>{e||q(!1)}),()=>{e=!0}},[g]),(0,i.useEffect)(()=>{W.current?.scrollIntoView({block:"end"})},[P]);const C=(0,i.useRef)(null),h=(0,i.useCallback)(e=>{e.startsWith("Error:")&&(C.current=e.slice(6).trim()),N(n=>[...n,e])},[]),Q=(0,i.useCallback)(e=>f.filter(n=>{if(n.type!=="geojson"||!n.geojson)return!1;if(!e?.length)return!0;const t=je(n.geojson);return e.some(s=>s==="point"&&t.hasPoint||s==="line"&&t.hasLine||s==="polygon"&&t.hasPolygon)}),[f]),z=(0,i.useMemo)(()=>{const n=new Map;if(!g)return n;for(const t of f){if(t.type!=="geojson"||!t.geojson)continue;const s=new Set;for(const p of t.geojson.features.slice(0,1e3))for(const y of Object.keys(p.properties??{}))s.add(y);n.set(t.id,[...s])}return n},[f,g]),ee=(0,i.useCallback)(e=>{const n=a[e.fieldSource??"layer"];return n&&z.get(n)||[]},[z,a]),ne=(0,i.useCallback)((e,n)=>{T(t=>{const s={...t,[e]:n};for(const p of l.parameters)p.type==="field"&&(p.fieldSource??"layer")===e&&(s[p.id]=void 0);return s})},[l]),G=(0,i.useCallback)(e=>{const n=e.visibleWhen;if(!n)return!0;const t=a[n.param];return"in"in n?t!=null&&n.in.includes(t):t==null||!n.notIn.includes(t)},[a]),O=(0,i.useCallback)((e,n)=>{if(!n.features.length){h(`No features produced for "${e}"`);return}const t=v(e,n);B.current?.addOutputLayer(e);const s=S.getState().layers.find(p=>p.id===t);s&&c.current?.fitLayer(s)},[v,h,c]),R=(0,i.useCallback)(async(e,n)=>{const t=f.find(b=>b.id===a.layer),s=f.find(b=>b.id===a.overlay);if(!t?.geojson){const b="input layer no longer exists in the project";return h(`Error: ${b}`),b}if(a.overlay&&!s?.geojson){const b="overlay layer no longer exists in the project";return h(`Error: ${b}`),b}h(`Running "${l.name}" ${e}...`);const p=await n({tool_id:l.id,geojson:t.geojson,overlay:s?.geojson,parameters:a});for(const b of p.messages)h(b);const y=p.geojson;if(y?.type==="FeatureCollection"&&Array.isArray(y.features))return O(l.name,y),null;const X="engine returned invalid GeoJSON";return h(`Error: ${X}`),X},[f,a,l,h,O]),V=(0,i.useCallback)(async()=>{N([]),C.current=null;for(const n of l.parameters){if(!n.required||!G(n))continue;const t=a[n.id];if(t===void 0||t===""||t===null||Array.isArray(t)&&t.length===0||n.type==="number"&&Number.isNaN(t)){h(`Error: "${n.label}" is required`);return}}const e=xe({kind:"vector",toolId:l.id,toolName:l.name,engine:k,parameters:a});B.current=e,L(!0);try{let n=null;if(k==="sidecar")n=await R("on the Python sidecar",be);else if(k==="pyodide"){const s=Re(p=>h(`${p}...`));try{n=await R("in your browser (Pyodide)",Le)}finally{s()}}else{const s={layers:f,parameters:a,log:h,fitBounds:p=>c.current?.fitBounds(p),addResultLayer:O,duckdb:H,viewportBounds:()=>{const p=c.current?.getMap();if(!p)return null;const y=p.getBounds();return[y.getWest(),y.getSouth(),y.getEast(),y.getNorth()]}};await l.run(s)}const t=n??C.current;t?e.finish("error",t):e.finish("success")}catch(n){h(`Error: ${n.message}`),e.finish("error",n.message)}finally{L(!1)}},[l,a,k,f,h,O,R,c,G,H]),$=(0,i.useRef)(V);(0,i.useEffect)(()=>{$.current=V}),(0,i.useEffect)(()=>{U&&(J(!1),$.current())},[U]);const te=(0,i.useMemo)(qe,[]);return(0,o.jsx)(de,{open:g,onOpenChange:e=>{e||j(null)},children:(0,o.jsxs)(ue,{className:"max-w-3xl",children:[(0,o.jsxs)(le,{children:[(0,o.jsx)(ce,{children:r("processing.vectorTools.title")}),(0,o.jsx)(se,{children:r("processing.vectorTools.description")})]}),(0,o.jsxs)("div",{className:"flex gap-4",children:[(0,o.jsx)(K,{className:"h-[22rem] w-48 shrink-0 rounded-md border",children:(0,o.jsx)("div",{className:"p-1",children:te.map(e=>(0,o.jsxs)("div",{className:"mb-1",children:[(0,o.jsx)("div",{className:"px-2 py-1 text-xs font-medium text-muted-foreground",children:Te(r,e.group)}),e.tools.map(n=>(0,o.jsx)("button",{type:"button",onClick:()=>_(n.id),className:ae("w-full rounded-md px-2 py-1.5 text-start text-sm transition-colors hover:bg-accent",n.id===d&&"bg-accent font-medium text-accent-foreground"),children:Se(r,"vector",n)},n.id))]},e.group))})}),(0,o.jsxs)("div",{className:"flex min-w-0 flex-1 flex-col gap-3",children:[(0,o.jsx)("p",{className:"text-sm text-muted-foreground",children:Ee(r,"vector",l)}),(0,o.jsx)("div",{className:"flex flex-col gap-3",children:l.parameters.filter(G).map(e=>{const n=ke(r,"vector",l.id,e),t=(l.id==="dggs-grid"||l.id==="dggs-bin"||l.id==="dggs-compact")&&e.id==="resolution"?(()=>{const s=a.dggsType==="s2"||a.dggsType==="a5"||a.dggsType==="dggrid"||a.dggsType==="dggal"?a.dggsType:"h3",p=s==="dggal"?a.dggalType:a.dggridType,y=_e(s,typeof p=="string"?p:void 0);return{...n,max:y,label:r("processing.vectorTools.resolutionRange",{max:y})}})():n;return(0,o.jsx)(Oe,{param:t,value:a[e.id],layerOptions:Q(e.geometryFilter),fieldOptions:e.type==="field"?ee(e):void 0,onChange:s=>ne(e.id,s)},e.id)})}),l.supportsSidecar||l.requiresSidecar?(0,o.jsxs)("div",{className:"flex flex-col gap-1",children:[(0,o.jsxs)(oe,{className:"flex items-center gap-1.5 text-xs",children:[(0,o.jsx)(he,{className:"h-3.5 w-3.5"})," ",r("processing.vectorTools.engine")]}),(0,o.jsxs)(pe,{value:k,onChange:e=>A(e.target.value),children:[(0,o.jsx)("option",{value:"client",disabled:l.requiresSidecar,children:r("processing.vectorTools.engineClient")}),(0,o.jsx)("option",{value:"sidecar",children:r("processing.vectorTools.engineSidecar")}),(0,o.jsx)("option",{value:"pyodide",children:r("processing.vectorTools.enginePyodide")})]}),k==="sidecar"&&I===null?(0,o.jsx)("p",{className:"text-xs text-muted-foreground",children:r("processing.vectorTools.checkingSidecar")}):null,k==="sidecar"&&I===!1?(0,o.jsx)("p",{className:"text-xs text-destructive",children:l.requiresSidecar?r("processing.vectorTools.sidecarUnavailablePyodide"):r("processing.vectorTools.sidecarUnavailableClient")}):null,k==="pyodide"?(0,o.jsx)("p",{className:"text-xs text-muted-foreground",children:r("processing.vectorTools.pyodideNote")}):null]}):null,(0,o.jsx)("div",{children:(0,o.jsxs)(ie,{onClick:V,disabled:F||k==="sidecar"&&I!==!0,className:"gap-2",children:[F?(0,o.jsx)(ge,{className:"h-4 w-4 animate-spin"}):(0,o.jsx)(me,{className:"h-4 w-4"}),r("processing.vectorTools.run")]})}),(0,o.jsxs)(K,{className:"h-24 rounded-md border bg-muted/30 p-2 font-mono text-xs",children:[P.length===0?(0,o.jsx)("span",{className:"text-muted-foreground",children:r("processing.vectorTools.outputPlaceholder")}):P.map((e,n)=>(0,o.jsx)("div",{className:"whitespace-pre-wrap",children:e},n)),(0,o.jsx)("div",{ref:W})]})]})]})]})})}export{Ue as VectorToolsDialog};
