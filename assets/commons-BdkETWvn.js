import{Hs as y,Vs as x,vs as A,ys as S}from"./maplibre-Mo3KD5jN.js";async function _(e){return new Promise(n=>{const t=new A({controller:!1,gl:e,parameters:{depthCompare:"less-equal"},width:null,height:null,onDeviceInitialized:r=>{n({deckInstance:t,device:r})}})})}async function C(e){const{deckInstance:n,device:t}=await _(e);let r,s,a;try{return r=t.createTexture({format:"rgba8unorm",width:1,height:1,sampler:{minFilter:"linear",magFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}}),s=new x(t,{vs:`#version 300 es
in vec2 pos;
out vec2 v_texcoord;
void main(void) {
