import{o as K}from"./rolldown-runtime-CEgmsyvS.js";import{t as re}from"./react-DIKiA8qT.js";import{C as oe,J as ie,Y as ae,d as se,f as le,h as Y,l as de,p as ce,u as ue,w as pe}from"./context-CBugVnNK.js";import{o as fe}from"./i18nInstance-DbcsXgO_.js";import{t as ge}from"./loader-circle-BbPUV0Xu.js";import{t as me}from"./play-kk2g5jll.js";import{t as he}from"./server-NCT67dXh.js";import{t as ye}from"./useTranslation-C7j1AGo-.js";import{J as S}from"./src-Bvi_6RDy.js";import{Jn as _e,Nn as ve,On as F,Pt as be,ft as we,jn as Z}from"./src-h3dEtYvq.js";import{nt as je}from"./src-BNxkPpQn.js";import{t as xe}from"./processing-history-D4Jgl367.js";import{a as ke,c as Se,o as Ee,s as Te}from"./processing-tool-i18n-CYssjZEZ.js";import{t as Ae}from"./pyodide-config-WUJ4AD_9.js";import{t as Ne}from"./duckdb-processing-DHfc1Qxe.js";import{t as Oe}from"./ParameterField-D_U-KOsZ.js";var Pe=`# AUTO-GENERATED \u2014 do not edit. Source of truth:
...
`,Ie=12e4,Ce=3e5,E=null,Re=0,b=new Map,D=new Set;function Ge(c){return D.add(c),()=>D.delete(c)}function Ve(c){for(const r of D)r(c)}function Fe(){return"/pyodide/pyodide-worker.js"}function De(){const c=Ae(),r=new Worker(Fe()),m=new Promise((w,p)=>{let _,u=!1;const j=g=>{if(!u){u=!0,_&&clearTimeout(_),r.terminate(),E=null;for(const[d,y]of b)b.delete(d),y.reject(new Error(g))}};_=setTimeout(()=>{const g="Timed out loading the Python runtime. Check your connection and try again.";j(g),p(new Error(g))},Ie),r.onmessage=g=>{const d=g.data??{};switch(d.type){case"progress":Ve(d.phase);break;case"ready":_&&clearTimeout(_),w();break;case"result":{const y=b.get(d.id);y&&(b.delete(d.id),y.resolve({geojson:d.geojson,messages:d.messages}));break}case"error":{const y=d.message||"Pyodide error";if(d.id===void 0)j(y),p(new Error(y));else{const a=b.get(d.id);a&&(b.delete(d.id),a.reject(new Error(y)))}break}}},r.onerror=g=>{const d=g.message||"Pyodide worker failed";j(d),p(new Error(d))}});return r.postMessage({type:"init",indexURL:c,vectorOpsSource:Pe}),m.then(()=>({worker:r}))}function Le(){return E??=De().catch(c=>{throw E=null,c}),E}async function Me(c){const{worker:r}=await Le(),m=Re++;return new Promise((w,p)=>{const _=setTimeout(()=>{if(b.has(m)){b.delete(m),r.terminate(),E=null;for(const[u,j]of b)b.delete(u),j.reject(new Error("Pyodide worker was reset after a timeout."));p(new Error("The Python (Pyodide) operation timed out."))}},Ce);b.set(m,{resolve:u=>{clearTimeout(_),w(u)},reject:u=>{clearTimeout(_),p(u)}}),r.postMessage({type:"run",id:m,request:c})})}var i=K(re(),1),o=K(fe(),1);function qe(){const c=[];for(const r of F){const m=r.group??"Tools";let w=c.find(p=>p.group===m);w||(w={group:m,tools:[]},c.push(w)),w.tools.push(r)}return c}function Ue({mapControllerRef:c}){const{t:r}=ye(),m=S(e=>e.ui.vectorToolOpen),w=S(e=>e.setVectorToolOpen),p=S(e=>e.layers),_=S(e=>e.addGeoJsonLayer),u=S(e=>e.ui.processingRerun),j=S(e=>e.setProcessingRerun),g=m!==null,[d,y]=(0,i.useState)(m??F[0].id),[a,T]=(0,i.useState)({}),[x,A]=(0,i.useState)("client"),[P,N]=(0,i.useState)([]),[L,M]=(0,i.useState)(!1),[I,q]=(0,i.useState)(null),[U,J]=(0,i.useState)(!1),W=(0,i.useRef)(null),B=(0,i.useRef)(null),s=(0,i.useMemo)(()=>Z(d)??F[0],[d]),H=(0,i.useMemo)(()=>Ne(),[]);(0,i.useEffect)(()=>{m&&y(m)},[m]),(0,i.useEffect)(()=>{const e={};for(const n of s.parameters)n.default!==void 0&&(e[n.id]=n.default);T(e),N([]),s.requiresSidecar?A("sidecar"):s.supportsSidecar||A("client")},[s]),(0,i.useEffect)(()=>{if(!g||!u||u.kind!=="vector")return;const e=ve(u.toolId,u.parameters);if(!Z(e.toolId)){N(n=>[...n,`Error: ${r("processing.history.toolUnavailable",{toolId:u.toolId})}`]),j(null);return}if(e.toolId!==s.id){d!==e.toolId&&y(e.toolId);return}T({...e.parameters}),(u.engine==="client"||u.engine==="sidecar"||u.engine==="pyodide")&&A((u.engine,u.engine)),j(null),u.autoRun&&J(!0)},[g,u,s,d,j,r]),(0,i.useEffect)(()=>{if(d!=="dggs-grid"||a.source!=="bbox"||a.west!==void 0||a.south!==void 0||a.east!==void 0||a.north!==void 0)return;const e=c.current?.getViewBounds();if(!e)return;const n=t=>Number(t.toFixed(6));T(t=>({...t,west:n(e[0]),south:n(e[1]),east:n(e[2]),north:n(e[3])}))},[d,a.source,c]),(0,i.useEffect)(()=>{if(!g)return;let e=!1;return we().then(n=>{e||q(n.available)}).catch(()=>{e||q(!1)}),()=>{e=!0}},[g]),(0,i.useEffect)(()=>{W.current?.scrollIntoView({block:"end"})},[P]);const C=(0,i.useRef)(null),h=(0,i.useCallback)(e=>{e.startsWith("Error:")&&(C.current=e.slice(6).trim()),N(n=>[...n,e])},[]),Q=(0,i.useCallback)(e=>p.filter(n=>{if(n.type!=="geojson"||!n.geojson)return!1;if(!e?.length)return!0;const t=je(n.geojson);return e.some(l=>l==="point"&&t.hasPoint||l==="line"&&t.hasLine||l==="polygon"&&t.hasPolygon)}),[p]),z=(0,i.useMemo)(()=>{const n=new Map;if(!g)return n;for(const t of p){if(t.type!=="geojson"||!t.geojson)continue;const l=new Set;for(const f of t.geojson.features.slice(0,1e3))for(const k of Object.keys(f.properties??{}))l.add(k);n.set(t.id,[...l])}return n},[p,g]),ee=(0,i.useCallback)(e=>{const n=a[e.fieldSource??"layer"];return n&&z.get(n)||[]},[z,a]),ne=(0,i.useCallback)((e,n)=>{T(t=>{const l={...t,[e]:n};for(const f of s.parameters)f.type==="field"&&(f.fieldSource??"layer")===e&&(l[f.id]=void 0);return l})},[s]),R=(0,i.useCallback)(e=>{const n=e.visibleWhen;if(!n)return!0;const t=a[n.param];return"in"in n?t!=null&&n.in.includes(t):t==null||!n.notIn.includes(t)},[a]),O=(0,i.useCallback)((e,n)=>{if(!n.features.length){h(`No features produced for "${e}"`);return}const t=_(e,n);B.current?.addOutputLayer(e);const l=S.getState().layers.find(f=>f.id===t);l&&c.current?.fitLayer(l)},[_,h,c]),G=(0,i.useCallback)(async(e,n)=>{const t=p.find(v=>v.id===a.layer),l=p.find(v=>v.id===a.overlay);if(!t?.geojson){const v="input layer no longer exists in the project";return h(`Error: ${v}`),v}if(a.overlay&&!l?.geojson){const v="overlay layer no longer exists in the project";return h(`Error: ${v}`),v}h(`Running "${s.name}" ${e}...`);const f=await n({tool_id:s.id,geojson:t.geojson,overlay:l?.geojson,parameters:a});for(const v of f.messages)h(v);const k=f.geojson;if(k?.type==="FeatureCollection"&&Array.isArray(k.features))return O(s.name,k),null;const X="engine returned invalid GeoJSON";return h(`Error: ${X}`),X},[p,a,s,h,O]),V=(0,i.useCallback)(async()=>{N([]),C.current=null;for(const n of s.parameters){if(!n.required||!R(n))continue;const t=a[n.id];if(t===void 0||t===""||t===null||Array.isArray(t)&&t.length===0||n.type==="number"&&Number.isNaN(t)){h(`Error: "${n.label}" is required`);return}}const e=xe({kind:"vector",toolId:s.id,toolName:s.name,engine:x,parameters:a});B.current=e,M(!0);try{let n=null;if(x==="sidecar")n=await G("on the Python sidecar",be);else if(x==="pyodide"){const l=Ge(f=>h(`${f}...`));try{n=await G("in your browser (Pyodide)",Me)}finally{l()}}else{const l={layers:p,parameters:a,log:h,fitBounds:f=>c.current?.fitBounds(f),addResultLayer:O,duckdb:H,viewportBounds:()=>c.current?.getViewBounds()??null};await s.run(l)}const t=n??C.current;t?e.finish("error",t):e.finish("success")}catch(n){h(`Error: ${n.message}`),e.finish("error",n.message)}finally{M(!1)}},[s,a,x,p,h,O,G,c,R,H]),$=(0,i.useRef)(V);(0,i.useEffect)(()=>{$.current=V}),(0,i.useEffect)(()=>{U&&(J(!1),$.current())},[U]);const te=(0,i.useMemo)(qe,[]);return(0,o.jsx)(de,{open:g,onOpenChange:e=>{e||w(null)},children:(0,o.jsxs)(ue,{className:"max-w-3xl",children:[(0,o.jsxs)(le,{children:[(0,o.jsx)(ce,{children:r("processing.vectorTools.title")}),(0,o.jsx)(se,{children:r("processing.vectorTools.description")})]}),(0,o.jsxs)("div",{className:"flex gap-4",children:[(0,o.jsx)(Y,{className:"h-[22rem] w-48 shrink-0 rounded-md border",children:(0,o.jsx)("div",{className:"p-1",children:te.map(e=>(0,o.jsxs)("div",{className:"mb-1",children:[(0,o.jsx)("div",{className:"px-2 py-1 text-xs font-medium text-muted-foreground",children:Te(r,e.group)}),e.tools.map(n=>(0,o.jsx)("button",{type:"button",onClick:()=>y(n.id),className:ae("w-full rounded-md px-2 py-1.5 text-start text-sm transition-colors hover:bg-accent",n.id===d&&"bg-accent font-medium text-accent-foreground"),children:Se(r,"vector",n)},n.id))]},e.group))})}),(0,o.jsxs)("div",{className:"flex min-w-0 flex-1 flex-col gap-3",children:[(0,o.jsx)("p",{className:"text-sm text-muted-foreground",children:Ee(r,"vector",s)}),(0,o.jsx)("div",{className:"flex flex-col gap-3",children:s.parameters.filter(R).map(e=>{const n=ke(r,"vector",s.id,e),t=(s.id==="dggs-grid"||s.id==="dggs-bin"||s.id==="dggs-compact")&&e.id==="resolution"?(()=>{const l=a.dggsType==="s2"||a.dggsType==="a5"||a.dggsType==="dggrid"||a.dggsType==="dggal"?a.dggsType:"h3",f=l==="dggal"?a.dggalType:a.dggridType,k=_e(l,typeof f=="string"?f:void 0);return{...n,max:k,label:r("processing.vectorTools.resolutionRange",{max:k})}})():n;return(0,o.jsx)(Oe,{param:t,value:a[e.id],layerOptions:Q(e.geometryFilter),fieldOptions:e.type==="field"?ee(e):void 0,onChange:l=>ne(e.id,l)},e.id)})}),s.supportsSidecar||s.requiresSidecar?(0,o.jsxs)("div",{className:"flex flex-col gap-1",children:[(0,o.jsxs)(oe,{className:"flex items-center gap-1.5 text-xs",children:[(0,o.jsx)(he,{className:"h-3.5 w-3.5"})," ",r("processing.vectorTools.engine")]}),(0,o.jsxs)(pe,{value:x,onChange:e=>A(e.target.value),children:[(0,o.jsx)("option",{value:"client",disabled:s.requiresSidecar,children:r("processing.vectorTools.engineClient")}),(0,o.jsx)("option",{value:"sidecar",children:r("processing.vectorTools.engineSidecar")}),(0,o.jsx)("option",{value:"pyodide",children:r("processing.vectorTools.enginePyodide")})]}),x==="sidecar"&&I===null?(0,o.jsx)("p",{className:"text-xs text-muted-foreground",children:r("processing.vectorTools.checkingSidecar")}):null,x==="sidecar"&&I===!1?(0,o.jsx)("p",{className:"text-xs text-destructive",children:s.requiresSidecar?r("processing.vectorTools.sidecarUnavailablePyodide"):r("processing.vectorTools.sidecarUnavailableClient")}):null,x==="pyodide"?(0,o.jsx)("p",{className:"text-xs text-muted-foreground",children:r("processing.vectorTools.pyodideNote")}):null]}):null,(0,o.jsx)("div",{children:(0,o.jsxs)(ie,{onClick:V,disabled:L||x==="sidecar"&&I!==!0,className:"gap-2",children:[L?(0,o.jsx)(ge,{className:"h-4 w-4 animate-spin"}):(0,o.jsx)(me,{className:"h-4 w-4"}),r("processing.vectorTools.run")]})}),(0,o.jsxs)(Y,{className:"h-24 rounded-md border bg-muted/30 p-2 font-mono text-xs",children:[P.length===0?(0,o.jsx)("span",{className:"text-muted-foreground",children:r("processing.vectorTools.outputPlaceholder")}):P.map((e,n)=>(0,o.jsx)("div",{className:"whitespace-pre-wrap",children:e},n)),(0,o.jsx)("div",{ref:W})]})]})]})]})})}export{Ue as VectorToolsDialog};
