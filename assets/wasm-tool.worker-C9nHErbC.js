...
async function __wbg_init(module_or_path) {
	...
	if (module_or_path === void 0) module_or_path = new URL("/assets/geolibre_wasm_bg-DuLToRaK.wasm", "" + import.meta.url);
...
async function initTools(source) {
	...
	if (!source) source = new URL("/assets/geolibre-cli-CfQYFwWI.wasm", "" + import.meta.url);
